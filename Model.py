...
class Model:
    def __init__(self,_player,useTrained,loadtrainstep,_lambda,_alpha):
        ...
        if useTrained:
            print('Using previously trained weights')
            #self.w1 = torch.load('./trainedWeights/w1_trained-'+str(totalTrained)+'-player-'+str(_player)+'-'+'lam-'+str(_lambda)+'-alpha-'+str(_alpha)+'.pth')
            #self.w2 = torch.load('./trainedWeights/w2_trained-'+str(totalTrained)+'-player-'+str(_player)+'-'+'lam-'+str(_lambda)+'-alpha-'+str(_alpha)+'.pth')
            #self.b1 = torch.load('./trainedWeights/b1_trained-'+str(totalTrained)+'-player-'+str(_player)+'-'+'lam-'+str(_lambda)+'-alpha-'+str(_alpha)+'.pth')
            #self.b2 = torch.load('./trainedWeights/b2_trained-'+str(totalTrained)+'-player-'+str(_player)+'-'+'lam-'+str(_lambda)+'-alpha-'+str(_alpha)+'.pth')
        else:
    ...
    def saveNetwork(self,totalTrained):
        torch.save(self.w1, './trainedWeights/w1_trained-'+str(totalTrained)+'-player-'+str(self.player)+'-'+'lam-'+str(self.lam)+'-alpha-'+str(self.alpha1)+'.pth')
        torch.save(self.w2, './trainedWeights/w2_trained-'+str(totalTrained)+'-player-'+str(self.player)+'-'+'lam-'+str(self.lam)+'-alpha-'+str(self.alpha1)+'.pth')
        torch.save(self.b1, './trainedWeights/b1_trained-'+str(totalTrained)+'-player-'+str(self.player)+'-'+'lam-'+str(self.lam)+'-alpha-'+str(self.alpha1)+'.pth')
        torch.save(self.b2, './trainedWeights/b2_trained-'+str(totalTrained)+'-player-'+str(self.player)+'-'+'lam-'+str(self.lam)+'-alpha-'+str(self.alpha1)+'.pth')